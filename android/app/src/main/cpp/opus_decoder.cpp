...
#define TAG "OpusDecoder"
#define LOGE(...) __android_log_print(ANDROID_LOG_ERROR, TAG, __VA_ARGS__)

// Decoder JNI — package com.example.robofelipe.audio.OpusDecoder

JNIEXPORT jlong JNICALL
Java_com_example_robofelipe_audio_OpusDecoder_nativeInitDecoder(
...
Java_com_example_robofelipe_audio_OpusDecoder_nativeDecodeBytes(
    JNIEnv *env, jobject thiz, jlong decoder_handle,
...
Java_com_example_robofelipe_audio_OpusDecoder_nativeReleaseDecoder(
    JNIEnv *env, jobject thiz, jlong decoder_handle)
{
    OpusDecoder *decoder = (OpusDecoder *)(intptr_t)decoder_handle;
    if (decoder != nullptr) {
